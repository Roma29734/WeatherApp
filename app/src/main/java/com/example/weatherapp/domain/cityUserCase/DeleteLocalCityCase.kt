...
class DeleteLocalCityCase @Inject constructor(private val repository: LocalRepository) {
    suspend operator fun invoke(weather: Weather) = repository.deleteWeather(weather)
}